            ...
            <footer>
                <div className="footer">
                    ...
                    <ul className="socials">
                        <li className="">
                            <a className="" href="#" aria-label='X'><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16"
                        ...
                        <li className="">
                            <a className="" href="#" aria-label='Facebook'><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16"
                                fill="currentColor" className="icons" viewBox="0 0 16 16">
                                <path
                        ...
                        <li className="">
                            <a className="" href="#" aria-label='Instagram'><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16"
                                fill="currentColor" className="icons" viewBox="0 0 16 16">
                                <path
